      ...
      <div className="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
        <div className="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <p role="list" className="mt-4 space-y-4">
              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Marketing </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Analytics </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Commerce </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Insights </Link>
              </li>
            </p>
          </div>
          <div className="mt-12 md:mt-0">
            ...
            <p role="list" className="mt-4 space-y-4">
              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Pricing </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Documentation </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Guides </Link>
              </li>

              <li style={{listStyle: 'none'}}>
                <Link to="/" className="text-sm font-normal text-gray-500 hover:text-gray-900"> API Status </Link>
              </li>
            </p>
          </div>
        </div>
              ...
              <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
                <form action="" method="post" id="revue-form" name="revue-form" target="_blank" className="p-1 mt-4 transition duration-500 ease-in-out transform border2 bg-gray-50 rounded-xl sm:max-w-lg sm:flex">
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                    <p className="block w-full px-5 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10">Notify me</p>
                  </div>
                </form>
              </div>
            </div>
