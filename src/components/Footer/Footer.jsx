                    ...
                    <div className="inline-flex items-center gap-2 list-none lg:ml-auto">
                      ...
                      >
                        ...
                        <div className="mt-4 sm:mt-0 sm:ml-3 revue-form-actions">
                          <p className="block w-full px-5 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10">
                            Notify me
                          </p>
                        </div>
                      </form>
