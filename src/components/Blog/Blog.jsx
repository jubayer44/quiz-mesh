  ...
  return (
    <div className="font-sans lg:w-1/2 mx-auto my-10 bg-slate-100 p-4 rounded-xl">
      ...
      <div className="bg-violet-200 rounded-md p-4 my-8">
        ...
        <p className="ml-[22px] mt-[10px] text-[20px]">
      ...
      <div className="bg-violet-200 rounded-md p-4 my-8">
        ...
        <p className="ml-[22px] mt-[10px] text-[20px]">
          The useRef hook is a new addition in React 16.8. The useRef is a hook
          that allows to directly create a reference to the DOM element in the
          functional component. The useRef returns a mutable ref object. The
          ...
          If you've worked with React for a while, you might be used to using
          refs for this purpose. <br /> <br />
          <strong>Keeping a mutable variable</strong> <br />
          Both in class components and functional components using Hooks, we
          have two ways of keeping data between re-renders: <br />
          * In class components. <br />* In functional components.
        </p>
      </div>
    </div>
  );
